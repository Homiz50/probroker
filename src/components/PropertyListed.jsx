...
import images from "../image/propertylistedphoto.png";
...
const PropertyListed = () => {
    ...
    return (
        <div className='w-full flex flex-col md:flex-row bg-purple-50 pt-8 pb-8 shadow'>
            <div className='lg:flex w-[67%]  lg:flex-row md:flex md:flex-col'>
                <div className="max-w-[80%] text-sm md:text-base ml-[6%] mx-auto p-6 lg:absolute">
                    <h1 className="text-4xl md:text-5xl mb-4 font-bold">
                        ...
                        <p className="text-lg sm:text-xl flex justify-center lg:justify-start items-center">
                            <span className='text-4xl md:text-5xl mb-4 mt-4 font-bold'>faster with</span>
                    ...
                    <ul className="list-outside  mb-4 hidden md:block">
                        <li>✅ Advertise for FREE</li>
                        <li>✅ Get unlimited enquiries</li>
                        <li>✅ Direct Marketing to all Real Estate Agents <span className='text-cyan-800 font-bold'>*</span></li>
                        <li>✅ Quick, Easy & Fast <span className='text-cyan-800 font-bold'>*</span></li>
                    </ul>
                </div>
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-2">
                                        {['1', '2', '3', '4', '5', '6', '6+'].map(size => (
                                            <button
                                                key={size}
                                                type="button"
                                                className={`px-3 py-2 text-xs rounded-full border border-gray-400 transition-colors duration-200 ${selectedPropertySize === size
